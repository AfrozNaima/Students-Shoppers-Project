							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											...
											<a href="javascript:void(0)" onclick="<?php echo 'addToCart(\''.$row["title"].'\','.$row["price"].')' ?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a><?php }} else{ ?>
